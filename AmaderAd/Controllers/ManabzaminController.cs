...
namespace AmaderAd.Controllers
{
    ...
    public class ManabzaminController : BaseController
    {
        ...
        public ActionResult GovtAd()
        {
            ...
            {
                NewspaperName = "Manabzamin",
                AdLocation = "Manabzamin Govt. Advertisement",
                TitleDescription = "Govt. Advertisement At Manabzamin",
        ...
        public ActionResult GovtCommercialAd()
        {
            ...
            {
                NewspaperName = "Manabzamin",
                AdLocation = "Manabzamin- Govt. Commercial Advertisement",
                TitleDescription = "Govt. Commercial Advertisement At Manabzamin",
